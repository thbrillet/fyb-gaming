...
pierre = User.create!(
  username: "pagehey",
  avatar: File.open(Rails.root.join("db/fixtures/users/pierre.jpeg")),
  ...
  interest_3: "Story",
  interest_4: "Compet",
  interest_5: "SmallTeam"
)
thibault = User.create!(
  username: "La gachette",
  avatar: File.open(Rails.root.join("db/fixtures/users/thibault.jpeg")),
...
fred = User.create!(
  username: "Frodo_dodo",
  avatar: File.open(Rails.root.join("db/fixtures/users/fred.jpeg")),
...
guillaume = User.create!(
  username: "Piccolo",
  avatar: File.open(Rails.root.join("db/fixtures/users/guillaume.jpeg")),
...
game_pc_guildwars2 = Game.create!(
  ...
  year: "2015",
  genre: "MMO",
  photo: File.open(Rails.root.join("db/fixtures/games/guildwars2.jpg"))
)
...
group_1 = Group.create!(
  ...
  photo: File.open(Rails.root.join("db/fixtures/games/summonerswars.jpg")
)
